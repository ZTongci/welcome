import { ConclutionTitle, MainTitle, PeriorTitle, ResumeItem } from "./Resume.style";
      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-lg-6">
            ...
            <ResumeItem>
              <MainTitle>Master of Business Administration &amp; International Management</MainTitle>
          ...
          <div className="col-lg-6">
            ...
            <ResumeItem>
              ...
              <p><em>YouTouch, Tokyo, JP</em></p>
              <p>
                <ul>
                  <li>Developed Website, smartphone application programs (React.js, Node.js, Flutter, Flask.Py, SpringBoot.Java).</li>
