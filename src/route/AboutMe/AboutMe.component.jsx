...
function AboutMe() {
  ...
  const SkillDatas = [
    ...
    {
      skillContent: `Backend develop ${BackendNumber}%`,
      percentage: BackendNumber,
    },
  ];
  ...
  const ClientDatas = [
    {
      ...
      iconColor: "#20b38e",
      count: HappyNumber,
      contentTitle: "Happy Clients:",
      content: "The current satisfaction rate of all clients is 100%.",
    },
    {
      iconClass: "fa-solid fa-list-check",
      iconColor: "#8a1ac2",
      count: ProjectsNumber,
      contentTitle: "Projects:",
      content:
        "Total number of projects undertaken in my main and side careers.",
    },
    {
      iconClass: "fa-regular fa-clock",
      iconColor: "#2cbdee",
      count: ExperienceNumber,
      contentTitle: "Years of Experience:",
      content:
        "Although I have limited experience, I am able to adapt to any project.",
    },
    {
      iconClass: "fa-solid fa-award",
      iconColor: "#ffb459",
      count: AdvantageNumber,
      contentTitle: "Advantage:",
      content:
        "I am proficient in programming for both front-end and back-end development using languages such as Flutter, Python, React, and Node.",
    },
  ];
  ...
  return (
    <Fragment>
      <Zoom>
        <TitleSection
          MainTitileHandle="About me"
          SubTitleHandle="Me Introducing My Experience, Skills, and Achievements."
        />
      </Zoom>
      <WhiteScreen>
        <Fade>
      ...
      <Zoom>
        <TitleSection
          MainTitileHandle="My Resume"
          SubTitleHandle="My Work Experience, Education Background, and Skills."
        />
      </Zoom>
      <WhiteScreen>
        <Fade>
